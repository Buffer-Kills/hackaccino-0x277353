...
<head>
    ...
    <title>Maggie Hotspot</title>
</head>

<body>

    <h1>
        <center>Welcome to Maggie Hotspot</center>
    </h1>

    <br><br>

    <button class="collapsible">Maggie </button>
    <div class="content">
        <br>
        <!-- <label>Oats Maggie</label> <button onclick="item_sub(1)"> - </button><input type="text" id = "1" value="0" readonly><button onclick="item_add(1)"> + </button> <br><br> -->
        <!-- <label>Veg Maggie</label> <button onclick="item_sub(2)"> - </button><input type="text" value="0" id="2"><button onclick="item_add(2)"> + </button> <br><br> -->
    ...
    <button class="collapsible">Sweets </button>
    <div class="content">
        <br>
        <!-- <label>Brownie</label><button onclick="item_sub(3)"> - </button><input type="text" id="3" value="0" readonly><button onclick="item_add(3)"> + </button><br><br> -->
