...
<head>
    ...
    <title>Kathi Junction</title>
</head>

<body>
    <h1>
        <center>Welcome to Kathi Junction</center>
    </h1>

    <button class="collapsible">Indian </button>
    <div class="content">
        <br><br>
        <!-- <label>Chole Bhature</label><button onclick="item_sub(1)"> - </button><input type="text" id="1" value="0" readonly><button onclick="item_add(1)"> + </button><br><br>
    <label>Aloo Parathe</label> <button onclick="item_sub(2)"> - </button><input type="text" id = "2" value="0" readonly><button onclick="item_add(2)"> + </button> <br><br> -->

        <label>Chole Bhature</label>
    ...
    <div class="content">
        <br>
        <!-- <label>Chocolate Shake</label> <button onclick="item_sub(3)"> - </button><input type="text" value="0" id="3"><button onclick="item_add(3)"> + </button> <br><br> -->
