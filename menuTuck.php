...
<body>
    ...
    <h1>
        <center>Welcome to Tuck Shop</center>
    </h1>
    <br><br>
    <button class="collapsible">Eatables </button>
    <div class="content">
        <br>
        <label>Chips</label>
    ...
    <br><br>
    <button class="collapsible">Utility </button>
    <div class="content">
        <br>
